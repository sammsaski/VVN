...
def train_zoom_in():
    ...
    # Training sequence
    model = R3D(img_res=IMG_RES, num_frames=NUM_FRAMES, num_classes=NUM_CLASSES, layer_sizes=(2, 2, 2, 2)) # for 18 layer R3D
...
if __name__=="__main__":
    print('Starting R3D model training ...')
    print('Starting R3D Model training on Zoom In video dataset.')
    
    train_zoom_in() # perform training
    
    print('Completed R3D Model training on Zoom In video dataset.')
    print('Starting R3D Model training on Zoom Out video dataset.')
    
    train_zoom_out() # perform training
    
    print('Completed R3D Model training on Zoom Out video dataset.')
